...
def convert_plain_to_csv(plain_name, csv_name):
    ...
    print(datetime.datetime.now(), "- Converting completed", time_diff_str(t0, time.time()))
...
def cleaning_data(dataset, file_name):
    ...
    print(datetime.datetime.now(), "- Write file completed", time_diff_str(t0, time.time()))
